 ...
 * @author anderson
 */
public class CircuitModule extends ComplexElement implements TextFile {

    public static final Element.CategoryData FLOWCHART_FILES = new Element.CategoryData("Circuit Module", "cm", new ImageIcon(ModularCircuit.class.getResource("/resources/icons/fugue/circuits.png")), new CircuitModule());
